...
data class Reference(
    ...
    fun resolve(other: String): Reference {
        ...
        val newPath = when (pathStr) {
            "" -> filePath
            else -> Paths.get(filePath).resolveSibling(pathStr).toString()
        }
    ...
    fun resolveRecursively(fragmentRegistry: FragmentRegistry) = fragmentRegistry.resolveRecursively(this)
...
class FragmentRegistry(rootFragments: Iterable<RootFragment>) {
    ...
    fun getOptional(reference: Reference): Fragment? {
        val resolvedReference = reference.resolveRecursively(this)
    ...
    tailrec fun resolveRecursively(reference: Reference): Reference {
